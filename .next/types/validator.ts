...
// Validate ../../src/app/api/v1/[...route]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/v1/[...route]">> = Specific
  const handler = {} as typeof import("../../src/app/api/v1/[...route]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
