    ...
    <main className="min-h-screen bg-[#040822]">
      ...
      <div className="pt-40 pb-32 px-8 max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
        <div className="flex-1 text-white">
          <h1 data-aos="fade-up" className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">Let&apos;s <span className="font-serif italic text-transparent bg-clip-text bg-gradient-to-r from-brand-electric to-cyan-400">talk</span> about your project.</h1>
          <p data-aos="fade-up" data-aos-delay="100" className="text-white/80 text-xl mb-16 max-w-lg leading-relaxed">
          ...
          <div className="space-y-10">
            <div data-aos="fade-up" data-aos-delay="200" className="flex items-center gap-6 group cursor-pointer">
            ...
            <div data-aos="fade-up" data-aos-delay="300" className="flex items-center gap-6 group cursor-pointer">
               <div className="w-16 h-16 rounded-full bg-brand-electric/10 flex items-center justify-center shrink-0 group-hover:bg-brand-electric group-hover:text-[#040822] transition-colors duration-500 text-brand-electric">
        ...
        <div data-aos="fade-left" className="flex-1 w-full max-w-xl relative">
