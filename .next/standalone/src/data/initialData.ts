export const initialServices = [
  ...
  },
  {
    ...
    whyText: "Your website is your 24/7 salesperson. We don't use bloated templates. We build custom, scalable architectures focused entirely on user experience and conversion rate optimization.",
  ...
  },
  {
    ...
    whyText: "YouTube is the world's second-largest search engine. By optimizing your metadata, thumbnails, and retention hooks, we ensure your content is discovered by thousands of new viewers.",
...
export const initialInvoices = [
  {
    ...
    clientName: "Alpha Global Tech",
    clientEmail: "billing@alphaglobal.io",
    clientAddress: "102 Silicon Avenue, San Francisco, CA",
    status: "PAID",
    issueDate: "2026-08-01",
    dueDate: "2026-08-15",
    items: [
      { description: "Brand Identity Design & Guidelines", quantity: 1, unitPrice: 1200, total: 1200 },
      { description: "Custom UI/UX Prototyping (Figma)", quantity: 1, unitPrice: 800, total: 800 }
    ],
    subtotal: 2000,
    discount: 100,
    taxRate: 5,
    taxAmount: 95,
    total: 1995,
    notes: "Thank you for partnering with Scaleminte! All deliverables provided in high resolution.",
  ...
  },
  {
    ...
    clientEmail: "finance@luminastudios.com",
    clientAddress: "450 Broadway, New York, NY",
    status: "PENDING",
    issueDate: "2026-08-10",
    dueDate: "2026-08-25",
    items: [
      { description: "Monthly Meta & Google Ads Management (August)", quantity: 1, unitPrice: 1500, total: 1500 },
      { description: "10x High-Retention Reel Video Edits", quantity: 10, unitPrice: 75, total: 750 }
    ],
    subtotal: 2250,
    discount: 0,
    taxRate: 0,
  ...
  },
  {
    ...
    clientEmail: "ops@vertexlogistics.com",
    clientAddress: "88 Harbor Boulevard, Chicago, IL",
    status: "OVERDUE",
    issueDate: "2026-07-20",
    dueDate: "2026-08-05",
    items: [
      { description: "Complete E-commerce Web Development (Phase 1)", quantity: 1, unitPrice: 3500, total: 3500 }
    ],
    subtotal: 3500,
    discount: 200,
    taxRate: 8,
    taxAmount: 264,
    total: 3564,
    notes: "Please settle outstanding balance at earliest convenience.",
    logoUrl: "/images/logo.png",
    signatureUrl: ""
  }
];
