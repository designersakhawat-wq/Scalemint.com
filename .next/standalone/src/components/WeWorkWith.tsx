...
export default function WeWorkWith() {
  return (
    <section className="bg-[#040822] -mt-10 relative z-30 pt-32 pb-16 px-6 text-center">
      ...
      <div className="inline-flex items-center gap-2 border-2 border-brand-electric rounded-full px-4 py-2 text-brand-electric font-semibold text-sm shadow-[0_0_15px_rgba(48,255,151,0.2)]">
