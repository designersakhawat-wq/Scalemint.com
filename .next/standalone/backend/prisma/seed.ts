import { PrismaClient, Role, ContactStatus } from "@prisma/client";
...
async function main() {
  ...
  const portfolio = [
    { title: "EduTech App Rebrand", slug: "edutech-app-rebrand", category: "Graphic Design", image: "/images/startup.jpg", isFeatured: true, order: 1 },
    { title: "Brand Growth Strategy", slug: "brand-growth-strategy", category: "Social Media Management", image: "/images/storefront.jpg", isFeatured: true, order: 2 },
    { title: "Aurora & Co. E-commerce", slug: "aurora-co-ecommerce", category: "Web Development", image: "/images/ecommerce.jpg", isFeatured: true, order: 3 },
    { title: "Nexus Plaza Corporate", slug: "nexus-plaza-corporate", category: "Video Editing", image: "/images/corporate.jpg", isFeatured: true, order: 4 },
    { title: "Social Media Campaign", slug: "social-media-campaign", category: "Meta Ads", image: "/images/startup.jpg", isFeatured: true, order: 5 },
    { title: "Local Artisan Reach", slug: "local-artisan-reach", category: "Google Ads", image: "/images/storefront.jpg", isFeatured: false, order: 6 },
    { title: "Channel Optimization", slug: "channel-optimization", category: "YouTube Video SEO", image: "/images/corporate.jpg", isFeatured: false, order: 7 }
  ];
  ...
  // 9. Seed Sample Contact Submissions
  const submissions = [
    {
      firstName: "Alexander",
      lastName: "Wright",
